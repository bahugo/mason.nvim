...
return {
  ...
  python = { "autoflake", "autopep8", "black", "blackd-client", "blue", "debugpy", "flake8", "isort", "jedi-language-server", "mypy", "pydocstyle", "pyflakes", "pylama", "pylint", "pyproject-flake8", "pyre", "pyright", "python-lsp-ruff", "python-lsp-server", "reorder-python-imports", "rstcheck", "ruff", "ruff-lsp", "semgrep", "sourcery", "usort", "vulture", "yapf" },
  r = { "r-languageserver" },
  raku = { "raku-navigator" },
